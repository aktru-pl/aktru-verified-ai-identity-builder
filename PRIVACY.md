...
Selected website and registry files are processed locally through browser APIs and held only in the current session. The application has no backend, account, database, analytics, telemetry or external API. It does not upload or persist selected files.
